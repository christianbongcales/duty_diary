                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="role" id="role" class="form-control">
                                ...
                                <option value="1" {{ $diary->role_id === 1 ? 'selected' : '' }}>Administrator</option>
                                <option value="2" {{ $diary->role_id === 2 ? 'selected' : '' }}>Supervisor</option>
                                <option value="3" {{ $diary->role_id === 3 ? 'selected' : '' }}>Trainee</option>
                            </select>
                        </div>
